        ...
        with col1:
            ...
            with col_b:
                desired_hourly_rate = st.number_input(
                    ...
                    value=500,
                    step=100,
                    help="「これ以下なら絶対受けない最低ライン」です。完全初心者は500円、少し慣れたら600〜700円がおすすめ。"
                )
...
【重要】判定基準について
このツールは低単価タスク・データ入力・文字起こし・初心者ライティングなど、
時給500円〜800円が相場のジャンルを想定しています。
...
• アンケート・タスク：100〜500円
• ライティング（初心者）：300〜700円
• ライティング（経験者）：700〜1,500円
• 簡単なWeb制作（AI活用）：1,000〜2,000円
• 専門記事ライティング：1,500〜3,000円

希望時給は「これ以下なら絶対受けない最低ライン」として扱い、
案件のジャンルと相場を考慮して現実的な判定をしてください。
...
【あなたの情報】
- 作業スピード: {work_speed}
- 希望時給（最低ライン）: {desired_hourly_rate}円
